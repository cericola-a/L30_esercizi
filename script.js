...
// Chiama la funzione e salva il risultato in una variabile, poi stampala
    ...
    let sommaRestituita = somma(10,50)
    console.log(sommaRestituita)
...
// Stampa di nuovo l'array
    let colori = ["Rosso", "Verde", "Bianco"]
    console.log(colori)

    colori.push("Bisque", "Indaco", "Violetto")

    console.log(colori);
    
    colori.pop(colori[colori.length - 1])
